...
const RealAPI = {
  ...
  createCheckout: (planId, cycleMonths, paymentMethod, promoCode = '') => apiRequest('/account/orders/checkout', { method: 'POST', body: JSON.stringify({ planId, cycleMonths, paymentMethod, promoCode }) }),
